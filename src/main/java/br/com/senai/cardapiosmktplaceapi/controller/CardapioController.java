...
public class CardapioController {
	...
	public ResponseEntity<?> listarPor(@RequestParam(name = "id-restaurante") Integer idDoRestaurante,
			@RequestParam(name = "pagina") java.util.Optional<Integer> pagina) {
	...
	public ResponseEntity<?> alterar(
		...
		Cardapio cardapioAtualizadoCardapio = service.alterar(cardapioSalvo);
		return ResponseEntity.ok(converter(cardapioAtualizadoCardapio));
	}
