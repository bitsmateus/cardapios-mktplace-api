...
public class NovaOpcaoDoCardapio {
	...
	@NotNull(message = "o id da opção é obrigatorio")
	@Positive(message = "o id da opçao deve ser positivo")
	...
	@NotNull(message = "O indicador de recomendação é obrigatorio")
	private Confirmacao recomendado;
	
	@NotNull(message = "A seção é obrigatorio")
	private Secao secao;
