...
public class CardapioServiceImpl implements CardapioService {
	...
	private Secao getSecaoPor(NovaOpcaoDoCardapio novaOpcao) {
		...
		Preconditions.checkArgument(secao.isAtivo(), "A seção está inativa");
		return secao;
	}
	...
	private void validarDuplicidadeEm(List<NovaOpcaoDoCardapio> opcoesDoCardapio) {
		for (NovaOpcaoDoCardapio novaOpcao : opcoesDoCardapio) {
			...
			Preconditions.checkArgument(qtdeDeOcorrencias == 1,
					"A opção '" + novaOpcao.getIdDaOpcao() + "' está duplicada no cardapio");
		}
	}
	...
	public Cardapio buscarPor(Integer id) {
		...
		Preconditions.checkNotNull(cardapioEncontrado, "Não foi econtrado cardapio para o id informado");
		Preconditions.checkArgument(cardapioEncontrado.isAtivo(), "O cardapio está inativo");
	...
	public void atualizarStatusPor(Integer id, Status status) {
		...
		Preconditions.checkNotNull(cardapio, "Não foi econtrado cardapio para o id informado");
